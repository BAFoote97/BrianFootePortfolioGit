...
public class MarkerScript : MonoBehaviour {
	...
	void Update () {
        ...
        playerCharacter = GameObject.FindGameObjectWithTag("Scene Reference").GetComponent<SceneManageScript>().CurrentPlayer;
        if (Camera.current != null)
        {
            gameObject.transform.LookAt(transform.position + Camera.current.transform.rotation * Vector3.forward,
            ...
            distanceValue = Vector3.Distance(playerCharacter.transform.position, currentObject.transform.position);
